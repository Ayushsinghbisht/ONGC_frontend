...
export default function Dashboard() {
  ...
  >
    ...
    <nav className="flex flex-col gap-4 text-gray-700">
      <button className="btn btn-ghost w-full justify-start hover:bg-blue-100 hover:text-blue-600 hover:shadow-md transition duration-200">
        Home
      </button>
      <button className="btn btn-ghost w-full justify-start hover:bg-blue-100 hover:text-blue-600 hover:shadow-md transition duration-200">
        Rooms
  ...
  <div className="flex-1 flex flex-col">
    ...
    <div className="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 overflow-auto">
      {/* Example Card */}
      <div className="bg-white rounded-xl shadow p-6 hover:shadow-lg hover:ring-2 hover:ring-blue-300 transition duration-200 cursor-pointer">
